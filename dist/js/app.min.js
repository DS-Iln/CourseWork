...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"constructPerspage\": () => (/* binding */ constructPerspage)\n/* harmony export */ });\n/* harmony import */ var _autoAuthorizate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./autoAuthorizate.js */ \"./source/js/modules/autoAuthorizate.js\");\n\r\n\r\nfunction constructPerspage() {\r\n    const logoutButtons = document.querySelectorAll('#logout-button');\r\n    let currentUser = JSON.parse(localStorage.getItem('currentUser'));\r\n\r\n    if (!currentUser.autoAuth) {\r\n        window.addEventListener(\"beforeunload\", () => {\r\n            localStorage.setItem('currentUser', JSON.stringify({\r\n                surname: '',\r\n                name: '',\r\n                email: '',\r\n                password: '',\r\n                points: 0,\r\n                favorite: [],\r\n                role: 'User',\r\n                autoAuth: false\r\n            }));\r\n        });\r\n    }\r\n\r\n    logoutButtons.forEach((elem) => {\r\n        elem.addEventListener('click', logout);\r\n    })\r\n};\r\n\r\nfunction logout() {\r\n    let currentUser = {\r\n        surname: '',\r\n        name: '',\r\n        email: '',\r\n        password: '',\r\n        points: 0,\r\n        favorite: [],\r\n        role: 'User',\r\n        autoAuth: false\r\n    };\r\n    localStorage.setItem('currentUser', JSON.stringify(currentUser));\r\n    window.location.href = 'index.html';\r\n};\r\n\r\n\r\n\r\nif ((0,_autoAuthorizate_js__WEBPACK_IMPORTED_MODULE_0__.htmlName)() === 'persAccount.html') {\r\n\r\n}\r\n\r\n// Если autoAuth === false, то при переходе с registered.html на persAccount.html происходит сброс аккаунта\r\n\r\n// Если при фокусе на input на главном экране на мобильной клавиатуре стрелочку \"дальше\", то срабатывает tabindex на следующие inputs, а нужно выполнить поиск (функция search)    -    Вроде исправлено, нужно проверить\n\n//# sourceURL=webpack://coursework/./source/js/modules/personalAccount.js?");
